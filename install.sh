...
function set_install_log() {
    if [[ ! $INSTALL_LOG ]]; then
	command_exists tr || exit_with_failure "Command 'tr' not found. Use --log to set the INSTALL_LOG."
	command_exists head || exit_with_failure "Command 'head' not found. Use --log to set the INSTALL_LOG."
